---
"@playwright-labs/fixture-mailpit": minor
---

Initial release of the Mailpit fixture package — find, read, send and delete emails straight from tests via the [Mailpit API](https://mailpit.axllent.org/docs/api-v1/):
