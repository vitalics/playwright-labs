---
"@playwright-labs/reporter-core": major
"@playwright-labs/reporter-email": patch
"@playwright-labs/reporter-slack": patch
"@playwright-labs/reporter-otel": patch
"@playwright-labs/reporter-prometheus-remote-write": patch
---

First release of `@playwright-labs/reporter-core` — the unified base for all `@playwright-labs/reporter-*` packages.
