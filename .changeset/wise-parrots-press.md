---
"@playwright-labs/fixture-otel": major
---

Introduce `@playwright-labs/fixture-otel` — extended `test` and `expect` for Playwright with OTel metric fixtures, a span helper, and custom matchers.
