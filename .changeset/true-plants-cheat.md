---
"@playwright-labs/reporter-email": minor
---

Feature: implement react & react-email support
...
```ts
import { SelectTrigger, SelectValue, SelectContent, SelectItem, SelectLabel, SelectSeparator } from "@playwright-labs/reporter-email/templates/shadcn";
```
