---
"@playwright-labs/prometheus-core": major
"@playwright-labs/reporter-prometheus-remote-write": major
"@playwright-labs/fixture-prometheus": major
---
...
test("track API calls", async ({ page, useCounterMetric, useGaugeMetric }) => {
