...
bun a @playwright-labs/reporter-prometheus-remote-write # bun
```
...
[`@playwright-labs/fixture-prometheus`](../fixture-prometheus).
...
export const test = mergeTests(prometheusTest);
```
