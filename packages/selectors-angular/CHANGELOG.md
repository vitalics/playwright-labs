...
- 7d6ee21: [test]: Remove unused config option

## 1.1.0

### Minor Changes

- 8bfcdbc: Migrated shared selector parsing logic to `@playwright-labs/selectors-core`.
...
- d9262c5: ## `@playwright-labs/selectors-angular` — initial release
