...
export interface PlaywrightReportShadcnChartEmailProps {
  result: FullResult;
  testCases: NodemailerTestCases;
}

export function PlaywrightReportShadcnChartEmail({
  result,
  testCases,
}: PlaywrightReportShadcnChartEmailProps): React.ReactElement {
  ...
  const total   = testCases.length || 1; // avoid div-by-zero
        ...
        e("div", { style: { maxWidth: "600px", margin: "32px auto", padding: "0 16px" } },
          e(Card, { className: "overflow-hidden" },
            ...
            e(CardHeader, {
              ...
              e("div", null,
                e("h1", { style: { margin: "0", fontSize: "18px", fontWeight: "600", color: "#0f172a", letterSpacing: "-0.01em" } },
                  "Playwright Test Report",
                ),
                e("p", { style: { margin: "4px 0 0", fontSize: "13px", color: "#64748b" } },
            ...
            // Chart section
            e("div", { style: { padding: "20px 24px", borderBottom: "1px solid #e2e8f0" } },
              e("p", {
                style: {
                  margin: "0 0 10px",
                  fontSize: "12px",
              ...
              e("div", {
                ...
                passW > 0 && e("div", {
                  title: `${passW}% passed`,
                  style: { width: `${passW}%`, height: "100%", backgroundColor: "#16a34a" },
                }),
                failW > 0 && e("div", {
                  title: `${failW}% failed`,
                  style: { width: `${failW}%`, height: "100%", backgroundColor: "#e11d48" },
                }),
                skipW > 0 && e("div", {
                  title: `${skipW}% skipped`,
                  style: { width: `${skipW}%`, height: "100%", backgroundColor: "#94a3b8" },
                }),
              ),
              // Legend
              e("div", { style: { display: "flex", gap: "16px", marginTop: "8px" } },
                e("span", { style: { fontSize: "12px", color: "#64748b", display: "flex", alignItems: "center", gap: "4px" } },
                  e("span", { style: { display: "inline-block", width: "8px", height: "8px", borderRadius: "2px", backgroundColor: "#16a34a" } }),
                  `${passW}% passed`,
                ),
                e("span", { style: { fontSize: "12px", color: "#64748b", display: "flex", alignItems: "center", gap: "4px" } },
                  e("span", { style: { display: "inline-block", width: "8px", height: "8px", borderRadius: "2px", backgroundColor: "#e11d48" } }),
                  `${failW}% failed`,
                ),
                e("span", { style: { fontSize: "12px", color: "#64748b", display: "flex", alignItems: "center", gap: "4px" } },
                  e("span", { style: { display: "inline-block", width: "8px", height: "8px", borderRadius: "2px", backgroundColor: "#94a3b8" } }),
                  `${skipW}% skipped`,
                ),
              ),
            ),
            // Stats
            e("div", { style: { display: "flex", borderBottom: "1px solid #e2e8f0" } },
              ...
              e("div", { style: { flex: "1", padding: "16px 0", textAlign: "center", borderLeft: "1px solid #e2e8f0", borderRight: "1px solid #e2e8f0" } },
            ...
            e(CardContent, { style: { paddingTop: "16px" } },
              ...
              ...testCases.map(([testCase, testResult], i) => {
                ...
                return e("div", {
                  ...
                  e("p", { style: { margin: "0", fontSize: "11px", color: "#64748b", fontFamily: "monospace", minWidth: "50px", textAlign: "right" as const } },
...
export default PlaywrightReportShadcnChartEmail;
