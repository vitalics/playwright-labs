...
- 65be558: Initial release. Shared email primitives extracted from `@playwright-labs/fixture-gmail` / `@playwright-labs/fixture-mailpit` into their own dependency-free package (no `@playwright/test` peer dependency):
