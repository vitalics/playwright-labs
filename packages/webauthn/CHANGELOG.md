...
- 65be558: Initial release. Extracted the core WebAuthn/passkey primitives out of `@playwright-labs/fixture-webauthn` into their own dependency-light package (no `@playwright/test` peer dependency, just `playwright-core` for `CDPSession` typing):
